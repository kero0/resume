...
- Working to develop more accurate 3D driver positioning for AR applications; using multiple cameras, additional sensors, and machine learning
- Created test plan to accurately test 3D eye location with sub-millimeter accuracy to evaluate planned supplier and additional sensors
{{{experience-end}}}
