...
* Experience
{{{experience-start(Infotainment Systems Software Engineer FCG *|* Ford Motor Company,March 2024 -- Present)}}}
...
#+begin_multicols
- Programming Languages: ARM Assembly, Bash, C, C++, Haskell, JavaScript, MATLAB, Python, Rust
